...
import cn.mccreefei.service.impl.SM4ServiceImpl;
...
public class MessageController {
    ...
    public void receiveMessage(Message message) throws Exception{
        String str1=SM4ServiceImpl.generateKey();
